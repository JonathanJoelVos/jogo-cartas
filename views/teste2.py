...
dados_turno = {
    ...
    'dados_monstros': [[2, 'karthus', 10, 5, 'Sobrepujar', 'gragas', 8, 8, 'gordo'],
                       [3, None, 'foca', 7, 7, 'lucas', None], [1, 'gragas', 8, 7, 'obeso'], [0]]
}
...
def criar_layout_batalha_j1(dados_monstros, nome_jogador, atacante, vida_j1, mana_j1, spellmana_j1):
    layout_batalha_j1 = []
...
layout = [
    ...
    [
        criar_layout_monstros_j1(monstros_j1, dados_turno["j1"], dados_turno["turno"],
                                 dados_turno["em_batalha"], dados_turno["atacou"],
                                 dados_turno["contador_de_passes"])
    ],
    [
        criar_layout_batalha_j1(monstros_j1_batalha, dados_turno["j1"], dados_turno["atacante"], dados_turno["vida_j1"],
                                dados_turno["mana_j1"], dados_turno["spellmana_j1"])
    ],
    [
    ...
    [
        ...
        criar_layout_batalha_j2(monstros_j2_batalha, dados_turno["j2"], dados_turno["atacante"])

    ],
    [
        criar_layout_monstros_j2(monstros_j2, dados_turno["j2"], dados_turno["turno"],
                                 dados_turno["em_batalha"], dados_turno["atacou"],
                                 dados_turno["contador_de_passes"])
    ]
]
