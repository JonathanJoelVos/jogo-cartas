...
class Jogo:
    ...
    def realizar_batalha(self):
        ...
        for i in range(len(atacante.monstros_em_batalha)):
            if defensor.monstros_em_batalha[i] != None:
                sobrepujar = False
    ...
    def recebe_inteiro(self,inteiro):
        return inteiro
    
    def recebe_monstros(self,monstros):
        return monstros
    
    def recebe_tabuleiro(self,tabuleiro):
        return tabuleiro
    
    def recebe_feitico(self,feitico):
        return feitico
